...
class Agent:
    ...
    def choose_action(self, observation):
        ...
        # for action to be selected we save in action varibale
        self.action = action
        ...
        # dimension for compatibility with our neral network
    ...
    def learn(self, state, reward, state_, done):
        ...
        with tf.GradientTape(persistent=True) as tape:
            ...
            state_value = self.actor_critic(state)
            state_value_ = self.actor_critic(state_)

            # for the calculation of our loss we have to get rid
            # of that batch dimension, so we have to squeeze these two parameters
            state_value = self.actor_critic(state_value)
            state_value_= self.actor_critic(state_value_)
